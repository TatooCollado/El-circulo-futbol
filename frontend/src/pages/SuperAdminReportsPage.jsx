...
export const SuperAdminReportsPage = () => {
  ...
  return (
    <section className="space-y-6">
      <PageHero
        eyebrow="Control del complejo"
        title="Reportes"
        description="Indicadores del período seleccionado para entender ocupación, reservas e ingresos aprobados."
        icon={TrendingUp}
        statLabel="Ocupación"
        statValue={formatPercent(report.resumen.ocupacionPromedio)}
      />
