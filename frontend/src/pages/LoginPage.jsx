...
const AuthVisual = () => (
  <div className="relative hidden min-h-[520px] overflow-hidden rounded-xl bg-slate-950 text-white shadow-xl lg:block">
    ...
    <div className="absolute bottom-8 left-8 right-8">
      ...
      <p className="mt-3 max-w-md leading-7 text-emerald-50/85">
